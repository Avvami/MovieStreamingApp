...
import com.bignerdranch.android.moviestreamingapp.databinding.FragmentSeriesBinding
...
class SeriesFragment : Fragment() {
    ...
    override fun onCreateView(
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    snapshot.children.forEach { foreach ->
                        if (foreach.child("movie").value == false) {
        ...
        binding.seriesGroupBack.setOnClickListener {
